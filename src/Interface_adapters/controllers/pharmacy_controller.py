...
class MedicineController:
    ...
    def update(self, id: int, nom: str, prix: float, quantite: int, date_expiration=None):
        input_data = UpdateMedicineInput(id=id, nom=nom, prix=prix, quantite=quantite, date_expiration=date_expiration)
        use_case = UpdateMedicineUseCase(self.repo)
        return use_case.execute(input_data)
